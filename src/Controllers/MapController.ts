            ...
            if (LayerName.indexOf("gwwsite") > -1) {
                ...
                this.geojson[LayerName] = {
                    ...
                    onEachFeature: (feature, layer) => {
                        ...
                        strVar += "          <strong>Station: <\/strong><a href='http://groundwaterwatch.usgs.gov/{0}?{1}' target='_blank' >".format(configuration.redirects["Site"],'S='+feature.properties["SITE_NO"] + this.getNetworkLinkParams(feature.properties["NETWORK_CD"])) + feature.properties["SITE_NO"] + "</a>";
                        strVar += "          <br \/>";
